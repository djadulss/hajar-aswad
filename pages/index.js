...
import LogoImage from '../common/static/images/logoha.jpeg';
...
import { Container, SocialShare } from '../component';
...
const IndexPage = () => (
  <LanguageProvider messages={messages}>
    <React.Fragment>
      <Head>
        {/* Load google fonts */}
        <title>PT. Hajar Aswad Bone</title>
        <link
      ...
      <MainWrapper>
        <LogoImageContainer>
          <Link href={'/one'}>
            <a>
              <img src={LogoImage} alt="logo" width="142" height="42" />
            </a>
          </Link>
        </LogoImageContainer>
        <ParticleWrapper>
